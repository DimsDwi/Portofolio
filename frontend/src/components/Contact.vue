...
atau bertanya.</p>
 <a href="mailto:emailanda@example.com" class="bg-blue-600 textwhite font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transitioncolors duration-300 inline-block mb-12">
 Kirim Email
 </a>
