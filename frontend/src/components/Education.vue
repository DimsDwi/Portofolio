...
const educationHistory = [
 { id: 1, period: '2022 - Sekarang', institution: 'Universitas Gadjah
Mada', major: 'S1 - Teknik Informatika' },
 { id: 2, period: '2019 - 2022', institution: 'SMA Negeri 1 Teladan
Yogyakarta', major: 'MIPA' }
];
</script>
<template>
